...
const BillPayableGroupPaymentFormViewPrototype = {
    init(formContainer){
...
const BillPayableGroupPaymentFormView = function (presenter){
    this.presenter = presenter;
    this.presenter.setView(this);
}

BillPayableGroupPaymentFormView.prototype = BillPayableGroupPaymentFormViewPrototype;
BillPayableGroupPaymentFormView.prototype.constructor = BillPayableGroupPaymentFormView;

export default BillPayableGroupPaymentFormView;