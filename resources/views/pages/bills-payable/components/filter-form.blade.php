        ...
        <div class="basis-4/5">
            <div class="mb-4">
                <div id="date_range_picker" date-rangepicker class="flex items-center">
                    ...
                    <div class="relative basis-1/5 ml-4">
                        ...
                        <input
                            id="start_emision_date"
                            name="start_emision_date" 
                            type="text" 
                            value="{{$start_emision_date}}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            placeholder="Seleccione fecha inicial"
                            autocomplete="off"
                        >
                    </div>
                    <span class="text-gray-500 ml-4">hasta</span>
                    <div class="relative basis-1/5 ml-4">
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg 
                                class="w-5 h-5 text-gray-500 dark:text-gray-400" 
                        ...
                        <input 
                            id="end_emision_date"
                            name="end_emision_date" 
                            type="text" 
                            value="{{$end_emision_date}}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
            ...
            <div class="flex items-center">
                <span class="text-gray-500">Es factura en Bs</span>
                <input
                    class="ml-4"
                    data-form="filter"
                    id="isDolar"
