...
class PointSaleDollarRecordSaintExport implements FromView, WithEvents, WithTitle
{
    protected $data;
    ...
    {
        $this->data = $data;
        $this->row_count_by_user = $this->getTotalRowsWorkSheetByUser($data['point_sale_dollar_records_saint']);
    ...
    */
    ...
    {
        return view('exports.point_sale_dollar.point_sale_dollar_saint', $this->data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                if ($this->data['point_sale_dollar_records_saint']->count() > 0){
                    $event->sheet->styleCells(
                        'A:C', 
                        [
                            'numberFormat' => [
                    ...
                    $event->sheet->setCellValue('G6', $this->data['total_point_sale_dollar_from_saint']->MontoDiv);
                    $event->sheet->mergeCells('G6:H6');
                    $event->sheet->setCellValue('I6', $this->data['total_point_sale_dollar_from_saint']->Monto);
                    ...
                    foreach($this->row_count_by_user as $key_user => $user_row_count){
                        ...
                        foreach($this->data['point_sale_dollar_records_saint'][$key_user] as $dates){
    ...
    {
        return 'Entradas de punto de venta internacional de SAINT';
    }
}
