...
class CreateBsDenominationRecords extends Migration
{
    ...
    public function up()
    {
        Schema::connection('web_services_db')->create('bs_denomination_records', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('web_services_db')->dropIfExists('bs_denomination_records');
    }
}
