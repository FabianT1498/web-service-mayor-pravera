...
class CreatePagoMovilBsRecords extends Migration
{
    ...
    public function up()
    {
        Schema::connection('web_services_db')->create('pago_movil_bs_records', function (Blueprint $table) {
            $table->id();
            $table->float('amount');
    ...
    {
        Schema::connection('web_services_db')->dropIfExists('pago_movil_bs_records');
